...
const Resume = (props) => {
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      <ResumeHeading
        heading={"YABA COLLEGE OF TECHNOLOGY LAGOS"}
      ...
      <div className="experience-container">
        ...
        <div className="experience-description">
          <span className="resume-description-text">
            ...
            online instructorim Rejuvenate360holdings.
          </span>
        </div>
        <div className="experience-description">
          <span className="resume-description-text">
          ...
          <span className="resume-description-text">
            ...
            designs. Responsive design email template for user monthly
            transaction reports using Html5, CSS3, Bootstrap4.
          </span>
          <br />
          <span className="resume-description-text">
